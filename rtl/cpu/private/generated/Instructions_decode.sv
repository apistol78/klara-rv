...
wire is_B = is_OP63; // is_BLT | is_BGEU | is_BLTU | is_BEQ | is_BGE | is_BNE
wire is_I = is_LHU | is_XORI | is_FENCE | is_JALR | is_LH | is_LBU | is_LB | is_LW | is_ADDI | is_SLTIU | is_SLTI | is_ORI | is_ANDI;
wire is_J = is_OP6f; // is_JAL
wire is_R = is_SRLI | is_SRL | is_SLL | is_SLT | is_SLTU | is_SLLI | is_SRA | is_SRAI | is_SH1ADD | is_SUB | is_MIN | is_MINU | is_MAXU | is_CPOP | is_MAX | is_CTZ | is_SEXT_B | is_ZEXT_H | is_ROR | is_SEXT_H | is_ROL | is_REV8 | is_CLZ | is_ORN | is_SH1ADDUW | is_ADDUW | is_XOR | is_XNOR | is_SH2ADD | is_SH3ADD | is_ANDN | is_SH2ADDUW | is_SLLIUW | is_SH3ADDUW | is_ADD | is_ORC_B | is_FLE | is_FEQ | is_FDIV | is_FCVT_S_WU | is_FLT | is_FCVT_S_W | is_FCVT_W_S | is_DIV | is_AND | is_FCVT_WU_S | is_DIVU | is_FADD | is_FMIN | is_FMUL | is_MULHSU | is_MULHU | is_MULH | is_OR | is_REMU | is_REM | is_FMAX | is_MUL | is_FSGNJN | is_FSGNJ | is_RORI | is_FSGNJX | is_FSUB;
wire is_R4 = is_OP43 | is_OP47 | is_OP4b | is_OP4f; // is_FMADD | is_FMSUB | is_FNMSUB | is_FNMADD
wire is_S = is_OP23; // is_SH | is_SB | is_SW
wire is_U = is_OP37 | is_OP17; // is_LUI | is_AUIPC
wire is_CSR = is_CSRRC | is_CSRRS | is_MRET | is_CSRRW;

wire is_ARITHMETIC = is_XORI | is_ADDI | is_SLTIU | is_SLTI | is_ORI | is_ANDI | is_SRLI | is_SRL | is_SLL | is_SLT | is_SLTU | is_SLLI | is_SRA | is_SRAI | is_SH1ADD | is_SUB | is_MIN | is_MINU | is_MAXU | is_CPOP | is_MAX | is_CTZ | is_SEXT_B | is_ZEXT_H | is_ROR | is_SEXT_H | is_ROL | is_REV8 | is_CLZ | is_ORN | is_SH1ADDUW | is_ADDUW | is_XOR | is_XNOR | is_SH2ADD | is_SH3ADD | is_ANDN | is_SH2ADDUW | is_SLLIUW | is_SH3ADDUW | is_ADD | is_ORC_B | is_AND | is_OR | is_RORI | is_LUI | is_AUIPC;
wire is_COMPLEX = is_EBREAK | is_ECALL | is_WFI | is_CSRRC | is_CSRRS | is_MRET | is_CSRRW | is_FENCE | is_DIV | is_DIVU | is_MULHSU | is_MULHU | is_MULH | is_REMU | is_REM | is_MUL;
wire is_JUMP = is_JALR | is_JAL;
wire is_JUMP_CONDITIONAL = is_BLT | is_BGEU | is_BLTU | is_BEQ | is_BGE | is_BNE;
wire is_MEMORY = is_LHU | is_LH | is_LBU | is_LB | is_LW | is_SH | is_SB | is_SW;
wire is_FPU = is_FLE | is_FEQ | is_FDIV | is_FCVT_S_WU | is_FLT | is_FCVT_S_W | is_FCVT_W_S | is_FCVT_WU_S | is_FADD | is_FMIN | is_FMUL | is_FMAX | is_FSGNJN | is_FSGNJ | is_FSGNJX | is_FSUB | is_FMADD | is_FMSUB | is_FNMSUB | is_FNMADD;
